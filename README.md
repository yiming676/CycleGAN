# <center><font face="Arial" font size="18" font color=purple>CycleGAN</font></center>
...
- 数据集下载与展示：首先，你需要下载>apple2orange数据集，该数据集来源于>ImageNet，包含了苹果和橘子的图像。图像被统一缩放为256×256像素大小，其中用于训练的苹果图片996张、橘子图片1020张，用于测试的苹果图片266张、橘子图片248张。
